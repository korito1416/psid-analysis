...
def main():
    ...
    median_earnings = np.median(earnings_data) # TODO: Calculate median (hint: sort first)
    max_earnings = np.max(earnings_data) # TODO: Find maximum
    min_earnings = np.min(earnings_data) # TODO: Find minimum
